...
4. **Auto-calibrated horizon + warp** runs a lightweight Hough transform on the binary mask, rebuilds the trapezoid for the perspective transform, and blends it over time so clips from different cameras remain aligned automatically.
