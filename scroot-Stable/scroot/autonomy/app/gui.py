...
class ScooterApp(tk.Tk):
    ...
    def _build_ui(self) -> None:
        ...
        ttk.Label(self.run_frame, text="Lane Detector", style="Body.TLabel").grid(row=5, column=0, sticky="w")
        ...
        self.lane_profile_combo.grid(row=5, column=1, sticky="w")
        ...
        self.lane_profile_desc.grid(row=5, column=2, columnspan=2, sticky="w", padx=12)
        ...
        ttk.Label(self.run_frame, text="Companion Persona", style="Body.TLabel").grid(row=8, column=0, sticky="w")
        ...
        self.start_button.grid(row=9, column=0, pady=(24, 0), sticky="w")

        self.stop_button = ttk.Button(
            self.run_frame, text="Stop Pilot", command=self._stop_pilot, state=tk.DISABLED
        )
        self.stop_button.grid(row=9, column=1, pady=(24, 0), sticky="w")
