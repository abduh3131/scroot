...
4. **Fixed downward-tilted horizon + warp** keeps a deliberate trapezoid that points further toward the asphalt so scooter-mounted cameras see the lane ribbon anchored near the pavement instead of drifting toward the horizon.
