...
4. **Fixed downward-tilted horizon + warp** – A deliberate trapezoid keeps the viewpoint angled toward the asphalt so the overlay sits where scooter-mounted cameras expect it, avoiding the floaty horizon seen in adaptive attempts.
