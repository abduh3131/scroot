...
(cl:defmethod cl:initialize-instance :after ((m <SensorHub>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'SensorHub)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name scooter_control-msg:<SensorHub> is deprecated: use scooter_control-msg:SensorHub instead.")))
...
(cl:defmethod lidar_ranges-val ((m <SensorHub>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader scooter_control-msg:lidar_ranges-val is deprecated.  Use scooter_control-msg:lidar_ranges instead.")
  (lidar_ranges m))

(cl:ensure-generic-function 'angle_min-val :lambda-list '(m))
(cl:defmethod angle_min-val ((m <SensorHub>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader scooter_control-msg:angle_min-val is deprecated.  Use scooter_control-msg:angle_min instead.")
  (angle_min m))

(cl:ensure-generic-function 'angle_increment-val :lambda-list '(m))
(cl:defmethod angle_increment-val ((m <SensorHub>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader scooter_control-msg:angle_increment-val is deprecated.  Use scooter_control-msg:angle_increment instead.")
  (angle_increment m))

(cl:ensure-generic-function 'angle_max-val :lambda-list '(m))
(cl:defmethod angle_max-val ((m <SensorHub>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader scooter_control-msg:angle_max-val is deprecated.  Use scooter_control-msg:angle_max instead.")
  (angle_max m))

(cl:ensure-generic-function 'ultrasonic_distance-val :lambda-list '(m))
(cl:defmethod ultrasonic_distance-val ((m <SensorHub>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader scooter_control-msg:ultrasonic_distance-val is deprecated.  Use scooter_control-msg:ultrasonic_distance instead.")
  (ultrasonic_distance m))

(cl:ensure-generic-function 'imu_vector-val :lambda-list '(m))
(cl:defmethod imu_vector-val ((m <SensorHub>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader scooter_control-msg:imu_vector-val is deprecated.  Use scooter_control-msg:imu_vector instead.")
  (imu_vector m))

(cl:ensure-generic-function 'camera_frame-val :lambda-list '(m))
(cl:defmethod camera_frame-val ((m <SensorHub>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader scooter_control-msg:camera_frame-val is deprecated.  Use scooter_control-msg:camera_frame instead.")
  (camera_frame m))
...
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<SensorHub>)))
  ...
  (cl:format cl:nil "# Unified perception message from the sensor fusion node~%~%std_msgs/Header header~%~%# LiDAR data~%float32[] lidar_ranges~%float32 angle_min~%float32 angle_increment~%float32 angle_max~%~%# Ultrasonic sensor data~%float32 ultrasonic_distance~%~%# IMU data~%geometry_msgs/Vector3 imu_vector~%~%# Raw camera frame~%sensor_msgs/Image camera_frame~%~%================================================================================~%MSG: std_msgs/Header~%# Standard metadata for higher-level stamped data types.~%# This is generally used to communicate timestamped data ~%# in a particular coordinate frame.~%# ~%# sequence ID: consecutively increasing ID ~%uint32 seq~%#Two-integer timestamp that is expressed as:~%# * stamp.sec: seconds (stamp_secs) since epoch (in Python the variable is called 'secs')~%# * stamp.nsec: nanoseconds since stamp_secs (in Python the variable is called 'nsecs')~%# time-handling sugar is provided by the client library~%time stamp~%#Frame this data is associated with~%string frame_id~%~%================================================================================~%MSG: geometry_msgs/Vector3~%# This represents a vector in free space. ~%# It is only meant to represent a direction. Therefore, it does not~%# make sense to apply a translation to it (e.g., when applying a ~%# generic rigid transformation to a Vector3, tf2 will only apply the~%# rotation). If you want your data to be translatable too, use the~%# geometry_msgs/Point message instead.~%~%float64 x~%float64 y~%float64 z~%================================================================================~%MSG: sensor_msgs/Image~%# This message contains an uncompressed image~%# (0, 0) is at top-left corner of image~%#~%~%Header header        # Header timestamp should be acquisition time of image~%                     # Header frame_id should be optical frame of camera~%                     # origin of frame should be optical center of camera~%                     # +x should point to the right in the image~%                     # +y should point down in the image~%                     # +z should point into to plane of the image~%                     # If the frame_id here and the frame_id of the CameraInfo~%                     # message associated with the image conflict~%                     # the behavior is undefined~%~%uint32 height         # image height, that is, number of rows~%uint32 width          # image width, that is, number of columns~%~%# The legal values for encoding are in file src/image_encodings.cpp~%# If you want to standardize a new string format, join~%# ros-users@lists.sourceforge.net and send an email proposing a new encoding.~%~%string encoding       # Encoding of pixels -- channel meaning, ordering, size~%                      # taken from the list of strings in include/sensor_msgs/image_encodings.h~%~%uint8 is_bigendian    # is this data bigendian?~%uint32 step           # Full row length in bytes~%uint8[] data          # actual matrix data, size is (step * rows)~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'SensorHub)))
  "Returns full string definition for message of type 'SensorHub"
  (cl:format cl:nil "# Unified perception message from the sensor fusion node~%~%std_msgs/Header header~%~%# LiDAR data~%float32[] lidar_ranges~%float32 angle_min~%float32 angle_increment~%float32 angle_max~%~%# Ultrasonic sensor data~%float32 ultrasonic_distance~%~%# IMU data~%geometry_msgs/Vector3 imu_vector~%~%# Raw camera frame~%sensor_msgs/Image camera_frame~%~%================================================================================~%MSG: std_msgs/Header~%# Standard metadata for higher-level stamped data types.~%# This is generally used to communicate timestamped data ~%# in a particular coordinate frame.~%# ~%# sequence ID: consecutively increasing ID ~%uint32 seq~%#Two-integer timestamp that is expressed as:~%# * stamp.sec: seconds (stamp_secs) since epoch (in Python the variable is called 'secs')~%# * stamp.nsec: nanoseconds since stamp_secs (in Python the variable is called 'nsecs')~%# time-handling sugar is provided by the client library~%time stamp~%#Frame this data is associated with~%string frame_id~%~%================================================================================~%MSG: geometry_msgs/Vector3~%# This represents a vector in free space. ~%# It is only meant to represent a direction. Therefore, it does not~%# make sense to apply a translation to it (e.g., when applying a ~%# generic rigid transformation to a Vector3, tf2 will only apply the~%# rotation). If you want your data to be translatable too, use the~%# geometry_msgs/Point message instead.~%~%float64 x~%float64 y~%float64 z~%================================================================================~%MSG: sensor_msgs/Image~%# This message contains an uncompressed image~%# (0, 0) is at top-left corner of image~%#~%~%Header header        # Header timestamp should be acquisition time of image~%                     # Header frame_id should be optical frame of camera~%                     # origin of frame should be optical center of camera~%                     # +x should point to the right in the image~%                     # +y should point down in the image~%                     # +z should point into to plane of the image~%                     # If the frame_id here and the frame_id of the CameraInfo~%                     # message associated with the image conflict~%                     # the behavior is undefined~%~%uint32 height         # image height, that is, number of rows~%uint32 width          # image width, that is, number of columns~%~%# The legal values for encoding are in file src/image_encodings.cpp~%# If you want to standardize a new string format, join~%# ros-users@lists.sourceforge.net and send an email proposing a new encoding.~%~%string encoding       # Encoding of pixels -- channel meaning, ordering, size~%                      # taken from the list of strings in include/sensor_msgs/image_encodings.h~%~%uint8 is_bigendian    # is this data bigendian?~%uint32 step           # Full row length in bytes~%uint8[] data          # actual matrix data, size is (step * rows)~%~%~%"))
